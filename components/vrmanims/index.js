/*!
 * dvengine component — vrmanims (components/vrmanims/index.js) · folder-is-module · awe port
 ...
 * update(). Visible jointed figure. Props: { speed, color, position }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/vrmanims/index.js: DVEngine not loaded');

  global.DVEngine.register('vrmanims', function (props) {
    props = props || {};
