 ...
 * { text, color, width, height, position, billboard }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('image.js: AweRuntime not loaded');

  global.AweRuntime.register('image', function (props) {
    props = props || {};
