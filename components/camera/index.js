/*!
 * dvengine component — camera (components/camera/index.js) · folder-is-module · awe port
 ...
 * target, drive }. Set drive:false to only show the gizmo. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/camera/index.js: DVEngine not loaded');

  global.DVEngine.register('camera', function (props) {
    props = props || {};
