/*!
 * awe runtime component — particles
...
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('particles.js: AweRuntime not loaded');

  global.AweRuntime.register('particles', function (props) {
    props = props || {};
