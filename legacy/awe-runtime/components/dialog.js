 ...
 * { text, color, bg, width, position }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('dialog.js: AweRuntime not loaded');

  global.AweRuntime.register('dialog', function (props) {
    props = props || {};
