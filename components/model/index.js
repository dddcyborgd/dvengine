/*!
 * dvengine component — model (components/model/index.js) · folder-is-module · awe port
 ...
 * { url, scale, position, color, spin }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/model/index.js: DVEngine not loaded');

  global.DVEngine.register('model', function (props) {
    props = props || {};
