 ...
 * { position, count, radius, color, spin }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('group.js: AweRuntime not loaded');

  global.AweRuntime.register('group', function (props) {
    props = props || {};
