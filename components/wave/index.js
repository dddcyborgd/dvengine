/*!
 * dvengine component — wave (components/wave/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/wave/index.js: DVEngine not loaded');

  global.DVEngine.register('wave', function (props) {
    props = props || {};
    var mesh, geo, mat;
