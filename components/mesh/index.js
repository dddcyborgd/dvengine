/*!
 * dvengine component — mesh (components/mesh/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/mesh/index.js: DVEngine not loaded');

  global.DVEngine.register('mesh', function (props) {
    props = props || {};
