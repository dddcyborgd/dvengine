/*!
 * awe runtime component — background
 ...
 * top, bottom }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('background.js: AweRuntime not loaded');

  global.AweRuntime.register('background', function (props) {
    props = props || {};
