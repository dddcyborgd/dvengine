/*!
 * dvengine component — destination (components/destination/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/destination/index.js: DVEngine not loaded');

  global.DVEngine.register('destination', function (props) {
    props = props || {};
