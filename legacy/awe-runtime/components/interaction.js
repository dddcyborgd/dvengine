/*!
 * awe runtime component — interaction
 ...
 * Props: { color, hoverColor, position, size }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('interaction.js: AweRuntime not loaded');

  global.AweRuntime.register('interaction', function (props) {
    props = props || {};
