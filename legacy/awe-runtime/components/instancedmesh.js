/*!
 * awe runtime component — instancedmesh
 ...
 * { rows, cols, gap, shape:'box'|'sphere', color, animate }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('instancedmesh.js: AweRuntime not loaded');

  global.AweRuntime.register('instancedmesh', function (props) {
    props = props || {};
