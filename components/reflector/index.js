/*!
 * dvengine component — reflector (components/reflector/index.js) · folder-is-module · awe port
 ...
 * Props: { size, color, opacity, position }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/reflector/index.js: DVEngine not loaded');

  global.DVEngine.register('reflector', function (props) {
    props = props || {};
