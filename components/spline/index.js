/*!
 * dvengine component — spline (components/spline/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/spline/index.js: DVEngine not loaded');

  global.DVEngine.register('spline', function (props) {
    props = props || {};
