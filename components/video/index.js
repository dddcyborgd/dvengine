/*!
 * dvengine component — video (components/video/index.js) · folder-is-module · awe port
 ...
 * Clean-room, no remote URL. Props: { color, width, height, position }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/video/index.js: DVEngine not loaded');

  global.DVEngine.register('video', function (props) {
    props = props || {};
