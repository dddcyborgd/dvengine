...
export function decodeIndex(decoder, mesh) {
...
export function decodeAttribute(decoder, mesh, attribute, accessorDef) {
...
export function initDecoderModule(_decoderModule) {
