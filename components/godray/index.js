/*!
 * dvengine component — godray (components/godray/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/godray/index.js: DVEngine not loaded');

  global.DVEngine.register('godray', function (props) {
    props = props || {};
