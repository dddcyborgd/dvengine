/*!
 * dvengine component — quarks (components/quarks/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/quarks/index.js: DVEngine not loaded');

  global.DVEngine.register('quarks', function (props) {
    props = props || {};
