/*!
 * dvengine component — iframe (components/iframe/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/iframe/index.js: DVEngine not loaded');

  global.DVEngine.register('iframe', function (props) {
    props = props || {};
