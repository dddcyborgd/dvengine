/*!
 * dvengine component — text (components/text/index.js) · folder-is-module · awe port
 ...
 * { text, color, bg, size, position, billboard }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/text/index.js: DVEngine not loaded');

  global.DVEngine.register('text', function (props) {
    props = props || {};
