/*!
 * dvengine component — avatar (components/avatar/index.js) · folder-is-module · awe port
 ...
 * position }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/avatar/index.js: DVEngine not loaded');

  global.DVEngine.register('avatar', function (props) {
    props = props || {};
