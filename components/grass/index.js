/*!
 * dvengine component — grass (components/grass/index.js) · folder-is-module · awe port
 ...
 * { count, size, color, ground, windStrength }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/grass/index.js: DVEngine not loaded');

  global.DVEngine.register('grass', function (props) {
    props = props || {};
