/*!
 * dvengine component — bird (components/bird/index.js) · folder-is-module · awe port
 ...
 * { count, radius, speed, color }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/bird/index.js: DVEngine not loaded');

  global.DVEngine.register('bird', function (props) {
    props = props || {};
