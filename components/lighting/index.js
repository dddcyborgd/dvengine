/*!
 * dvengine component — lighting (components/lighting/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/lighting/index.js: DVEngine not loaded');

  global.DVEngine.register('lighting', function (props) {
    props = props || {};
