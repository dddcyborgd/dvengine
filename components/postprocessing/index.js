/*!
 * dvengine component — postprocessing (components/postprocessing/index.js) · folder-is-module · awe port
 ...
 * the DVEngine render loop does not expose a render hook — so this is a clean-room overlay approach:
 ...
 * Props: { vignette, grain, tint }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/postprocessing/index.js: DVEngine not loaded');

  global.DVEngine.register('postprocessing', function (props) {
    props = props || {};
