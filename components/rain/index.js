/*!
 * dvengine component — rain (components/rain/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/rain/index.js: DVEngine not loaded');

  global.DVEngine.register('rain', function (props) {
    props = props || {};
