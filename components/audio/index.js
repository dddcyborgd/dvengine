/*!
 * dvengine component — audio (components/audio/index.js) · folder-is-module · awe port
 ...
 * Props: { color, freq, position, range }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/audio/index.js: DVEngine not loaded');

  global.DVEngine.register('audio', function (props) {
    props = props || {};
