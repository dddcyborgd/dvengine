 ...
 * { top, bottom, intensity, background, position }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('envmap.js: AweRuntime not loaded');

  global.AweRuntime.register('envmap', function (props) {
    props = props || {};
