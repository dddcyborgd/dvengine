/*!
 * dvengine component — object (components/object/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/object/index.js: DVEngine not loaded');

  global.DVEngine.register('object', function (props) {
    props = props || {};
