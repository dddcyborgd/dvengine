/*!
 * dvengine component — fog (components/fog/index.js) · folder-is-module · awe port
 ...
 * { type:'linear'|'exp2', color, near, far, density }. Upstream design © oncyberio — MIT. https://github.com/oncyberio/awe · (c) 2026 BANKON / PYTHAI · MIT
 */
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/fog/index.js: DVEngine not loaded');

  global.DVEngine.register('fog', function (props) {
    props = props || {};
    var scene, prevFog;
