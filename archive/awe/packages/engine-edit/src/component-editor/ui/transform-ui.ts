...
import type { GuiFolderDescriptor, GuiGroupDescriptor } from "../gui-types";
import { XYZ } from "@oncyberio/engine/space/components/types";
...
export function getRotationUI(editor: Component3DEditor, opts: object = {}): GuiGroupDescriptor {
    return {
        type: "group" as const,
        label: "Rotation",
        slug: "rotation",
