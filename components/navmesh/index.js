/*!
 * dvengine component — navmesh (components/navmesh/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/navmesh/index.js: DVEngine not loaded');

  global.DVEngine.register('navmesh', function (props) {
    props = props || {};
