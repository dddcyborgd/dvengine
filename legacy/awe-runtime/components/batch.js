 ...
 * batching. Props: { count, color, spread, position }. Upstream design © oncyberio — MIT.
 */
(function (global) {
  'use strict';
  if (!global.AweRuntime) throw new Error('batch.js: AweRuntime not loaded');

  global.AweRuntime.register('batch', function (props) {
    props = props || {};
