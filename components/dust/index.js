/*!
 * dvengine component — dust (components/dust/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/dust/index.js: DVEngine not loaded');

  global.DVEngine.register('dust', function (props) {
    props = props || {};
