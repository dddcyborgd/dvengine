/*!
 * dvengine component — terrain (components/terrain/index.js) · folder-is-module · awe port
...
(function (global) {
  'use strict';
  if (!global.DVEngine) throw new Error('components/terrain/index.js: DVEngine not loaded');

  global.DVEngine.register('terrain', function (props) {
    props = props || {};
    var mesh, geo, mat;
